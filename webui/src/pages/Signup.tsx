        ...
        <div className="card p-6">
          ...
          <form onSubmit={submit} className="flex flex-col gap-3">
            ...
            <div>
              ...
              <p id="su-pw-hint" className="mt-1 text-caption text-txt3">
                At least 8 characters, with both letters and numbers. It expires every 30 days.
              </p>
            </div>
            <hr className="my-1 border-bd" />
            <div>
              <label htmlFor="su-org" className="text-sm font-medium">Organisation name</label>
            ...
            <div>
              <label htmlFor="su-gst" className="text-sm font-medium">
              ...
              <p id="su-gst-hint" className="mt-1 text-caption text-txt3">
